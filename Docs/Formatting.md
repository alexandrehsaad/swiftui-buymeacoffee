...
Use the [BuyMeACoffeeLinterPlugin](/Plugins/BuyMeACoffeeLinterPlugin/BuyMeACoffeeLinterPlugin.swift) to report
formatting issues as warnings across the whole package without changing source files:
